...
function App() {
  ...
  useEffect(() => {
    ...
    <body>
      ...
      <div className="Navbar"> <Nav /></div>Spot The Wine
      <div className="aLink">
        <a  href="" target="blank"><img src="https://cdn1.vectorstock.com/i/1000x1000/79/75/facebook-logo-icon-vector-29227975.jpg" height="30px" width="60px"></img></a> 
        <a className=href="" target="blank"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Instagram_logo_2016.svg/1200px-Instagram_logo_2016.svg.png" height="25px" width="50px"></img></a>
            </div>
       </header>
