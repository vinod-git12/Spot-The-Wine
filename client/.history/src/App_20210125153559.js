  ...
  useEffect(() => {
    ...
    <body>
      ...
      <header className="title">
        <div></div>
        <a className="aLink" href="" target="blank"><img src="https://cdn1.vectorstock.com/i/1000x1000/79/75/facebook-logo-icon-vector-29227975.jpg" height="30px" width="60px"></img></a> Spot The Wine
