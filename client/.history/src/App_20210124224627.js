  ...
  useEffect(() => {
    ...
    <body>
      ...
      <header className="title">
        ...
        <a className="aLink" href="" target="blank"><img src="https://logos-world.net/wp-content/uploads/2020/04/Linkedin-Symbol.png" height="30px" width="45px"></img></a> Spot The Wine
