  ...
  if (!wine) {
    ...
    return (
      <div className="showImage">
        <img src={wine.fields.image} alt={wine.name} height="350px" width="280px"/>
        <div className="showInfo" height="350px" width="280px>
        <h2>Name: {wine.fields.name}</h2>
        <h2>Varietal: {wine.fields.varietal}</h2>
        <h2>Price: ${wine.fields.price}</h2>
      
        <a href={wine.fields.description} target="blank">
