  ...
  useEffect(() => {
    ...
    <body>
      ...
      <header className="title">
        ...
        <a className="aLink" href="" target="blank"><img src="https://www.macobserver.com/wp-content/uploads/2019/05/workfeatured-GitHub-2.png" height="30px" width="60px"></img></a>
